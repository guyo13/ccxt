...
module.exports = class cyborgfi extends Exchange {
    userInit (userConfig) {
        let base = this.getKey (userConfig, 'exchangeBaseUrl');
        if (typeof base === 'undefined') {
            base = 'https://app.cyborg.fi:9010';
            userConfig['exchangeBaseUrl'] = base;
        }
        this.setProp (this, 'exchangeBaseUrl', base);
    }
    ...
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                'logo': 'https://avatars.githubusercontent.com/u/83159811',
                'test': {
                    'dapiPublic': this.exchangeBaseUrl + '/dapi/v1',
                    'dapiPrivate': this.exchangeBaseUrl + '/dapi/v1',
                    'fapiPublic': this.exchangeBaseUrl + '/fapi/v1',
                    'fapiPrivate': this.exchangeBaseUrl + '/fapi/v1',
                    'fapiPrivateV2': this.exchangeBaseUrl + '/fapi/v2',
                    'public': this.exchangeBaseUrl + '/api/v3',
                    'private': this.exchangeBaseUrl + '/api/v3',
                    'v3': this.exchangeBaseUrl + '/api/v3',
                    'v1': this.exchangeBaseUrl + '/api/v1',
                },
                'api': {
                    'wapi': this.exchangeBaseUrl + '/wapi/v3',
                    'sapi': this.exchangeBaseUrl + '/sapi/v1',
                    'dapiPublic': this.exchangeBaseUrl + '/dapi/v1',
                    'dapiPrivate': this.exchangeBaseUrl + '/dapi/v1',
                    'dapiPrivateV2': this.exchangeBaseUrl + '/dapi/v2',
                    'dapiData': this.exchangeBaseUrl + '/futures/data',
                    'fapiPublic': this.exchangeBaseUrl + '/fapi/v1',
                    'fapiPrivate': this.exchangeBaseUrl + '/fapi/v1',
                    'fapiData': this.exchangeBaseUrl + '/futures/data',
                    'fapiPrivateV2': this.exchangeBaseUrl + '/fapi/v2',
                    'public': this.exchangeBaseUrl + '/api/v3',
                    'private': this.exchangeBaseUrl + '/api/v3',
                    'v3': this.exchangeBaseUrl + '/api/v3',
                ...
                'www': 'https://www.cyborg.fi',
                // TODO change it
                'referral': 'https://www.cyborg.fi/subscribe.html',
                'doc': [
                    'https://www.cyborg.fi/about.html',
                ],
                // TODO: change or remove it
                'api_management': 'https://www.cyborg.fi',
                'fees': 'https://www.cyborg.fi',
            },
            'api': {
            ...
            'options': {
                ...
                'broker': {
                    'spot': 'x-Cyborg-CCXT',
                    'margin': 'x-Cyborg-CCXT',
                    'future': 'x-Cyborg-CCXT',
                    'delivery': 'x-Cyborg-CCXT',
                },
                'accountsByType': {
                    'main': 'MAIN',
                    'spot': 'MAIN',
